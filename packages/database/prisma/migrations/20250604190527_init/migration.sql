...
-- CreateTable
CREATE TABLE "_EventLikes" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_EventLikes_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_EventLikes_B_index" ON "_EventLikes"("B");
...
-- AddForeignKey
ALTER TABLE "Match" ADD CONSTRAINT "Match_matchedWithId_fkey" FOREIGN KEY ("matchedWithId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_EventLikes" ADD CONSTRAINT "_EventLikes_A_fkey" FOREIGN KEY ("A") REFERENCES "Event"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_EventLikes" ADD CONSTRAINT "_EventLikes_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
